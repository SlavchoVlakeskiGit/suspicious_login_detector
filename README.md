...
A small Python tool to detect suspicious login activity by counting
...
3.  Optionally, set a custom threshold:

    ``` bash
    python main.py --threshold 5
    ```

4.  Check `data/suspicious_users.csv` for flagged users
